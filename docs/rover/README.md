...
- [`_pdf-polnaya-dokumentaciya.md`](_pdf-polnaya-dokumentaciya.md) — расшифровка официального PDF от 12.07.2026 (**архив**, описывает старую раскладку). Сам PDF (`hackathon_files/sverk_rover_full_documentation.pdf` в апстриме) из репозитория удалён за ненадобностью — расшифровки достаточно.
